...
export const SPAIN_CATEGORIES: SpainCategoryDef[] = [
  ...
  },
  {
    ...
    parentSlug: 'hogar-familia',
    keywords: ['organizar', 'organization', 'declutter', 'almacenaje', 'armario', 'ordenar'],
  ...
  },
  {
    ...
    nameEn: 'Home Decor',
    parentSlug: 'hogar-familia',
    keywords: ['decoracion', 'decor', 'interiorismo', 'deco', 'decorar', 'dormitorio', 'estilo nordico'],
  ...
  },
  {
    ...
    parentSlug: 'hogar-familia',
    keywords: ['bricolaje', 'diy', 'manualidades', 'reformar', 'carpinteria'],
  ...
  // ===== LIFESTYLE =====
  {
    ...
    keywords: ['moda', 'fashion', 'outfit', 'look', 'estilismo', 'ropa', 'ootd'],
  ...
  },
  {
    ...
    nameEn: 'Travel',
    parentSlug: 'lifestyle',
    keywords: ['viaje', 'travel', 'viajar', 'escapada', 'turismo', 'ruta', 'hotel'],
  ...
  },
  {
    ...
    parentSlug: 'lifestyle',
    keywords: ['familia', 'family', 'vida familiar', 'padres', 'hijos', 'plan familiar'],
  ...
  // ===== CONSUMO =====
  {
    ...
    parentSlug: 'consumo',
    keywords: ['supermercado', 'mercadona', 'lidl', 'ahorro', 'cesta'],
  ...
  },
  {
    ...
    parentSlug: 'consumo',
    keywords: ['farmacia', 'parafarmacia', 'proteccion solar', 'vitaminas', 'cuidado personal'],
  ...
  },
  {
    ...
    nameEn: 'Technology',
    parentSlug: 'consumo',
    keywords: ['tech', 'tecnologia', 'gadget', 'ordenador', 'smartphone', 'tablet'],
  ...
  },
  {
    ...
    nameEn: 'Automotive',
    parentSlug: 'consumo',
    keywords: ['coche', 'motor', 'conducir', 'suv', 'gasolina'],
  ...
  },
  {
    ...
    nameEn: 'Pets',
    parentSlug: 'consumo',
    keywords: ['mascota', 'perro', 'gato', 'pet', 'dog', 'cachorro', 'veterinario'],
  ...
  // ===== PROFESIONAL =====
  {
    ...
    keywords: ['emprender', 'negocio', 'startup', 'emprendedor', 'autonomo', 'freelance'],
  ...
  },
  {
    ...
    parentSlug: 'profesional',
    keywords: ['educacion', 'estudiar', 'oposiciones', 'universidad'],
  ...
  },
  {
    ...
    parentSlug: 'profesional',
    keywords: ['marketing', 'redes sociales', 'social media', 'seo', 'community manager'],
  ...
  },
  {
    ...
    nameEn: 'Law & Legal',
    parentSlug: 'profesional',
    keywords: ['abogado', 'derecho', 'ley', 'fiscal'],
  ...
  // ===== ENTRETENIMIENTO =====
  {
    ...
    keywords: ['futbol', 'football', 'gol', 'champions', 'laliga', 'barça'],
  ...
  },
  {
    ...
    nameEn: 'Gaming',
    parentSlug: 'entretenimiento',
    keywords: ['gaming', 'videojuego', 'gamer', 'playstation', 'xbox', 'fortnite', 'twitch'],
  ...
  },
  {
    ...
    parentSlug: 'entretenimiento',
    keywords: ['cine', 'serie', 'pelicula', 'netflix', 'actor', 'film', 'tvseries'],
  ...
  // ===== FOOD & DRINK =====
  {
    ...
    keywords: ['restaurante', 'gastro', 'gastronomia', 'tapas', 'brunch'],
