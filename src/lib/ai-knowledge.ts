...
7. Stories: solo Instagram; expiran a las 24 h. Dos vías: (a) rastreo automático cada 12 h SOLO de las creadoras en estado Acordado, Contratado, Envío, Publicado o Completado (el rastreo de stories se paga por story revisada, así que el PM DEBE marcar el estado cuando la creadora confirme; en Prospecto no se rastrean stories); (b) menciones en tiempo real vía Meta: cuando una creadora menciona a @vileda.es en una story, Meta avisa a la plataforma al instante y la story entra en la campaña, sin coste. La story cuenta solo si menciona a la marca (sticker de mención o hashtag objetivo).
