...
export async function register() {
  ...
  // Recurring run every 2 hours (dedup logic in runCronTracking prevents duplicate scrapes)
  setInterval(() => {
    executeTracking()
  }, TWO_HOURS_MS)

  console.log('[TKOC Auto-Tracker] Scheduled: initial run in 5 min, then every 2 hours')
}
