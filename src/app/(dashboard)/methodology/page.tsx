          ...
          items={
            es
              ? [
                  ...
                  "Estructura estandar del sector (la que usan las agencias): audiencia × CPM + interacciones valoradas (like 0,05-0,15; comentario 0,25-0,75; compartido/guardado 0,50-1,50; clic 0,50-2,00) y, opcionalmente, un multiplicador de confianza de 1,5 a 3 sobre el resultado. En Ajustes se fijan el valor por vista de los videos y el multiplicador; si el multiplicador esta activo, el informe lo declara junto al EMV.",
              ...
              : [
                  ...
                  "Standard industry structure (the one agencies use): audience × CPM + valued interactions (like 0.05-0.15; comment 0.25-0.75; share/save 0.50-1.50; click 0.50-2.00) and, optionally, a trust multiplier of 1.5 to 3 on the result. Settings holds the value per video view and the multiplier; when the multiplier is active the report discloses it next to the EMV.",
