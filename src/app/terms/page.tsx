  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      <div className="mb-6 flex items-center justify-end gap-2 text-sm">
        ...
        <a href="/terms/es" className="text-gray-500 hover:text-purple-600">Español</a>
      </div>
      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
        <section>
          ...
          <p>
            By accessing or using TKOC Intelligence (&quot;the Service&quot;), operated by DAMA Platforms S.L.
        ...
        <section>
          ...
          <p>
            ...
            DAMA Platforms S.L. All rights reserved.
          </p>
          <p>
